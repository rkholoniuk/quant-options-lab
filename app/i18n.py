...
TRANSLATIONS = {
    ...
    "ru": {
        "app_title": "Инструмент опционов",
        "inputs": "Параметры",
        "underlying_price": "Цена базового актива",
        "std_dev_pct": "Диапазон цен (±%)",
        "num_combos": "Количество комбинаций опционов",
        "option_n": "Опцион {n}",
        ...
        "short_call": "Продажа колла",
        "long_put": "Покупка пута",
        "short_put": "Продажа пута",
        "payoff_diagram": "Диаграмма прибыли/убытка",
        "xaxis_title": "Цена актива на экспирации",
        "yaxis_title": "Суммарный результат",
        "max_gain": "Макс. прибыль",
        "min_gain": "Мин. результат",
        "total_cost": "Стоимость входа в позицию",
        "max_gain_label": "Максимальная прибыль",
        "min_gain_label": "Минимальный результат (макс. убыток)",
        "bullish": "Бычий",
        "bearish": "Медвежий",
        "neutral": "Нейтральный",
        "invest": "Инвестировать",
        "dont_invest": "Не инвестировать",
        "footer": "Powered by ToxicVolt",
        "language": "Язык",
        "lang_en": "Английский",
        "lang_ru": "Русский",
        "lang_uk": "Украинский",
        "show_zero_line": "Показать линию P/L = 0",
        "show_strike_lines": "Показать линии страйков",
        "show_underlying_line": "Показать линию текущей цены",
...
def language_selector():
    ...
    lang_names = {
        ...
        "ru": TRANSLATIONS[lang_code]["lang_ru"],
        "uk": TRANSLATIONS[lang_code]["lang_uk"],
    }
    chosen = st.selectbox(
        t("language"),
        options=["en", "ru", "uk"],
        index=["en", "ru", "uk"].index(lang_code),
